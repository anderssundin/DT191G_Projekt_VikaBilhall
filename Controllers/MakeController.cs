...
namespace Projekt.Controllers
{
    ...
    public class MakeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MakeOfModel")] MakeModel makeModel)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var makeModel = await _context.Make.FindAsync(id);
            if (makeModel == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MakeOfModel")] MakeModel makeModel)
        {
            if (id != makeModel.Id)
            {
                return NotFound();
